# ocaml-cordova-plugin-device-motion-example

This is an example of the binding to the *device motion cordova plugin*. See the
binding
[here](https://github.com/dannywillems/ocaml-cordova-plugin-device-motion)

This application catches accelerometer data each second and show it in a new
...
* init_plugins: initialize plugins you need. Contains
  cordova-plugin-device-motion for this project.
